...
<header class="flex bg-blue-500 text-white shadow rounded-lg">
    <div class="container mx-auto flex items-center py-5 px-4 justify-between">
                    ...
                    <ul class="py-2">
                        ...
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="flex w-full items-center px-4 py-2 text-red-600 hover:bg-red-100">
        ...
        @guest
            <div class="flex items-center justify-end w-1/3 pr-6 space-x-2">
                <a href="{{ route('login') }}" class="bg-white text-blue-500 px-4 py-2 rounded-full hover:bg-blue-100 transition">
                    Přihlásit se
                </a>
                <a href="{{ route('register') }}" class="bg-white text-blue-500 px-4 py-2 rounded-full hover:bg-blue-100 transition">
                    Registrovat
                </a>
            </div>
        @endguest
